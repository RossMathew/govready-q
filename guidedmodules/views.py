...
def show_question(request, task, answered, context, q):
    ...
    return show_questions(request, task, answered, context, [q], is_answerable=is_answerable)

def show_question_get_context(request, task, answered, context, q, is_answerable):
...
def show_questions(request, task, answered, context, qq, is_answerable=True):
    from functools import reduce

    questions = [ show_question_get_context(request, task, answered, context, q, is_answerable) for q in qq ]
